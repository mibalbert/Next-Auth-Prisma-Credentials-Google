...
const Card = ({ tag, title, description, data, href, className }) => {
  return (
    // <div className="group relative mx-auto max-w-xl rounded-2xl bg-white/20 p-2.5 shadow-sm shadow-black/5 ring-[0.8px] ring-black/5 transition duration-200 hover:-translate-y-1 dark:bg-black/20 dark:shadow-white/5 dark:ring-white/5 md:w-full">
    <div
      className={cn(
    ...
    >
      ...
      <div className="relative h-full max-w-full rounded-[0.62rem] shadow-sm shadow-black/5 ring-[0.8px] ring-black/5">
        <Link href={href || "/auth/sign-in"} className="h-full w-full">
          {/* <article className="relative flex flex-col w-full h-full gap-2 px-5 py-5 pr-5 overflow-hidden bg-white rounded-lg shadow-md isolate shadow-gray-300 ring-1 ring-black/5 dark:bg-black dark:shadow-gray-800 dark:ring-white/5 sm:gap-8 sm:px-10 sm:py-6 lg:max-w-3xl lg:flex-row"> */}
          <article className="relative isolate flex h-full w-full flex-col gap-2 overflow-hidden rounded-lg bg-white px-5 py-5 pr-5 shadow-md shadow-gray-300 ring-1 ring-black/5 dark:bg-gray-950/70 dark:shadow-gray-800 dark:ring-white/5 sm:gap-8 sm:px-10 sm:py-6 lg:max-w-3xl lg:flex-row">
            <div>
