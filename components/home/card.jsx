...
const Card = ({ tag, title, description, data, href }) => {
  console.log(href);
  return (
    <div className="group relative mx-auto max-w-xl rounded-2xl bg-white/20 p-2.5 shadow-sm shadow-black/5 ring-[0.8px] ring-black/5 transition duration-200 hover:-translate-y-1 dark:bg-black/20 dark:shadow-white/5 dark:ring-white/5 md:w-full">
      ...
      <div className="relative h-full max-w-full rounded-[0.62rem] shadow-sm shadow-black/5 ring-[0.8px] ring-black/5">
        <Link href={href || "/auth/sign-in"} className="h-full w-full">
          <article className="relative isolate flex h-full w-full flex-col gap-2 overflow-hidden rounded-lg bg-white px-5 py-5 pr-5 shadow-md shadow-gray-300 ring-1 ring-black/5 dark:bg-black dark:shadow-gray-800 dark:ring-white/5 sm:gap-8 sm:px-10 sm:py-6 lg:max-w-3xl lg:flex-row">
            <div>
              ...
              <div className="group relative max-w-xl">
                <h3 className="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600 dark:text-gray-200 dark:group-hover:text-green-500">
                ...
                {!data ? (
                  ...
                  <pre>
                    <code className="mt-3 max-w-[90%] overflow-hidden text-sm leading-6  text-gray-600 dark:text-gray-200">
                      ...
                      <br />
                      And {data.length - 1} more Sessions stored
                    </code>
                  </pre>
                )}
              </div>
